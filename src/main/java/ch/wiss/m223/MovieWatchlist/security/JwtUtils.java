package ch.wiss.m223.MovieWatchlist.security;
...
public class JwtUtils {
    ...
    public String generateToken(String username) {
        ...
        return Jwts.builder().claims(claims).subject(username).issuedAt(new Date()).expiration(new Date(System.currentTimeMillis() + jwtExpirationMs)).signWith(getSignKey()).compact();
    }
